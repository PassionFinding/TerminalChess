...
white_a_pawn = Pawn(True, "🅿", "a2", False, False)
white_b_pawn = Pawn(True, "🅿", "b2", False, False)
white_c_pawn = Pawn(True, "🅿", "c2", False, False)
white_d_pawn = Pawn(True, "🅿", "d2", False, False)
white_e_pawn = Pawn(True, "🅿", "e2", False, False)
white_f_pawn = Pawn(True, "🅿", "f2", False, False)
white_g_pawn = Pawn(True, "🅿", "g2", False, False)
white_h_pawn = Pawn(True, "🅿", "h2", False, False)
...
black_a_pawn = Pawn(False, "🄿", "a7", False, False)
black_b_pawn = Pawn(False, "🄿", "b7", False, False)
black_c_pawn = Pawn(False, "🄿", "c7", False, False)
black_d_pawn = Pawn(False, "🄿", "d7", False, False)
black_e_pawn = Pawn(False, "🄿", "e7", False, False)
black_f_pawn = Pawn(False, "🄿", "f7", False, False)
black_g_pawn = Pawn(False, "🄿", "g7", False, False)
black_h_pawn = Pawn(False, "🄿", "h7", False, False)
...
black_piece = [black_a_pawn, black_b_pawn, black_c_pawn, black_d_pawn, black_e_pawn, black_f_pawn, black_g_pawn, black_h_pawn, black_right_rook, black_left_rook,
